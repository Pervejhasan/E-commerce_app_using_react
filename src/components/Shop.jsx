...
const Shop = ({ shop, Filter, allCategoryFilter, addToCart }) => {
  ...
  return (
    <div className="m-0 p-0  font-sans box-border  ">
      {showDetails ? (
        <>
          <div className="product-detail w-[600px] h-[350px]   sm:w-[900px] sm:h-[600px] z-50 fixed shadow-2xl top-12  bg-gray-100 border-4 border-solid border-gray-300 rounded-lg left-[2%] sm:left-[25%]">
            <button
